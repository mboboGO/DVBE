...
def save_data():
    ...
    ''' path setting '''
    split_path = '/userhome/raw_data/zsl_data/AWA2'
    save_data_path = checkdir(os.path.join('./awa2'))
    image_path = '/userhome/raw_data/AwA2-data/Animals_with_Attributes2/JPEGImages/'
    ...
    image_list = convert_mat_to_list(image_data['image_files'], 'awa2')
