...
def save_sun_data():
    ...
    ''' path setting '''
    split_path = '/userhome/raw_data/zsl_data/SUN'
    save_data_path = checkdir(os.path.join('./sun'))
    image_path = '/userhome/raw_data/SUN/images/'
    ...
    image_list = convert_mat_to_list(image_data['image_files'], 'sun')
    ...
    ''' save '''
    save_path = checkdir(os.path.join('./sun'))
